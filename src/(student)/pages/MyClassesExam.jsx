...
export default function MyClassesExam({ endPointParams, props }) {
  ...
  return (
    <div className='ml-[22rem] mr-24 my-16'>
      <h1 className='font-bold text-3xl'>My Classes Exams</h1>
      ...
      <div className='grid grid-cols-3 gap-10 my-8'>
        {posts.map((post) => (
          <div
            ...
            onClick={() => navigate(`/MyExams/`, { state: { post, classID: post.class_id } })}
          >
