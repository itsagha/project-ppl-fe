...
export default function EditExercise({ endPointParams }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateData(`${endPointParams}?id=${exerciseID}`, updatedExercise);
  ...
  return (
    <div className="ml-[22rem] mr-24 my-16">
      <h1 className="text-3xl font-bold mb-8">Edit Exercise for {post.title}</h1>
